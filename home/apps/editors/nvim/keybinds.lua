...
vim.keymap.set('n', '<Leader>cf', 'o-- FIX: <Esc>A',
	{
		noremap = true,
		silent = true,
		desc = 'Comment: FIX'
...
-- -------------------------------------------------
-- Navigate buffers
vim.keymap.set('n', '<C-Tab>', ':BufferLineCycleNext<CR>', { desc = 'Next buffer', silent = true })
vim.keymap.set('n', '<C-S-Tab>', ':BufferLineCyclePrev<CR>', { desc = 'Previous buffer', silent = true })
