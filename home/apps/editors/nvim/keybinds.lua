...
-- Comment
-- -------------------------------------------------
vim.keymap.set('v', '<Leader>cc', "<cmd>lua require('Comment.api').toggle.linewise(vim.fn.visualmode())<CR>",
    {
        noremap = true,
        silent = true,
...
vim.keymap.set('v', '<Leader>er', '<cmd><C-u>lua require("functions").replace_selection_with_clipboard()<CR>',
    {
        noremap = true,
        silent = true,
...
-- Buffer groups
vim.keymap.set('n', '<leader>bgt', '<cmd>BufferLineGroupToggle Tests<CR>', { desc = 'Toggle Tests group', silent = true })
