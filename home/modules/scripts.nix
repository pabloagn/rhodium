...
#     # Monitor configurations
#     declare -A monitor_configs=(
#       ["⊹ Main Only <i>(Single Display)</i>"]="$MAIN_MONITOR,''${MAIN_RESOLUTION}''${MAIN_REFRESH},0x0,$MAIN_SCALE"
#       ["⊹ External Only <i>(External Display)</i>"]="$EXTERNAL_MONITOR,$EXTERNAL_CONFIG"
#       ["⊹ Dual Setup <i>(Main + External)</i>"]="$MAIN_MONITOR,''${MAIN_RESOLUTION}''${MAIN_REFRESH},0x0,$MAIN_SCALE and $EXTERNAL_MONITOR,$EXTERNAL_CONFIG"
#       ["⊹ Mirror Mode <i>(Duplicate Display)</i>"]="$MAIN_MONITOR,''${MAIN_RESOLUTION}''${MAIN_REFRESH},0x0,$MAIN_SCALE and $EXTERNAL_MONITOR,''${MAIN_RESOLUTION}''${MAIN_REFRESH},0x0,$MAIN_SCALE"
#     )
#
#     # Show rofi menu
#     choice=$(printf '%s\n' "''${!monitor_configs[@]}" | ${pkgs.rofi}/bin/rofi -dmenu -i -P "λ " -theme "$ROFI_THEME" -markup-rows)
